import { InputName, InputErrors } from './types';
  ...
  for (const [name, value] of data) {
    ...
    switch (name) {
      ...
      case 'text': {
        ...
        if (value.length < 140) {
          errors[name] = 'Текст должен быть от 140 символов';
        }
        break;
      }
    ...
    // Название не больше 20 символов
    // Подводка до 140 символов
    // От 140 символов
    // Изображение минимум 200х200
  }
