...
import { Article, ArticleItemAPI, RelatedArticlesAPI, Source as TSource } from "../../types";
...
export const ArticlePage: FC = () => {
  ...
  const [sources, setSources] = React.useState<TSource[]>([]);
  ...
  React.useEffect(() => {
    ...
    Promise.all([
      ...
      const sources: TSource[] = responses[1];
